...
Help = lambda do |*args|
  ...
  puts "download, upload, new, open, edit, remove, list, search, public, web, and help\n\n\n"
  puts "-download, upload, new, open, edit, remove, and public take a filename as their parameter"
